...
from dfkit.utils.polars_utils import ensure_dataframe
...
def restore_registry_from_state(
    *,
    ...
    Examples:
        ...
        >>> from dfkit.registry.persistence import restore_registry_from_state
        >>> from dfkit.registry.models import DataFrameToolkitState
        >>> import polars as pl
